...
/*! Number of nodes, computed when calling resize, to avoid useless call of vector.size which could slow down loops */    
    size_t number_of_nodes;
    
/*! All nodes to which node no *n* is not linked */
	std::vector<size_t> possible_neighbors(const size_t& n) const; 
